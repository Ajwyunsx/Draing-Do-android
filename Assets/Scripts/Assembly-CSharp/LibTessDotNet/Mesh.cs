namespace LibTessDotNet
{
	internal class Mesh
	{
		...
		public Mesh()
		{
			MeshUtils.Vertex vertex = (_vHead = new MeshUtils.Vertex());
			MeshUtils.Face face = (_fHead = new MeshUtils.Face());
		...
		public MeshUtils.Edge MakeEdge()
		{
			...
			MeshUtils.MakeVertex(new MeshUtils.Vertex(), edge, _vHead);
			MeshUtils.MakeVertex(new MeshUtils.Vertex(), edge._Sym, _vHead);
			MeshUtils.MakeFace(new MeshUtils.Face(), edge, _fHead);
			return edge;
		}
